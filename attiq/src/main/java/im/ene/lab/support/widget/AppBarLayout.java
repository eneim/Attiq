...
public class AppBarLayout extends LinearLayout {
  ...
  public AppBarLayout(Context context, AttributeSet attrs) {
    ...
    mTargetElevation = a.getDimensionPixelSize(android.support.design.R.styleable
        .AppBarLayout_elevation, 0);
    setBackgroundDrawable(a.getDrawable(android.support.design.R.styleable
  ...
  public static class LayoutParams extends LinearLayout.LayoutParams {
     ...
     * .styleable#AppBarLayout_LayoutParams_layout_scrollInterpolator
  ...
  /**
   * The default {@link Behavior} for {@link AppBarLayout}. Implements the necessary
   * nested
  ...
  public static class Behavior extends HeaderBehavior<AppBarLayout> {
    ...
    @Override public boolean onStartNestedScroll(CoordinatorLayout parent, AppBarLayout child,
                                                 View directTargetChild, View target, int
                                                     nestedScrollAxes) {
    ...
    private static final String TAG = "AppBarLayout$Behavior";
    ...
    @Override int getTopBottomOffsetForScrollingSibling() {
    ...
    @Override boolean canDragView(AppBarLayout view) {
    ...
    @Override int getMaxDragOffset(AppBarLayout view) {
    ...
    @Override int getScrollRangeForDragFling(AppBarLayout view) {
    ...
    public boolean onNestedFling(final CoordinatorLayout coordinatorLayout,
                                 final AppBarLayout child, View target,
                                 float velocityX, float velocityY, boolean consumed) {

      int targetScrollingOffset = 0;
      ...
      if (!consumed) {
        ...
        if (velocityY < 0) {
          // We're scrolling down
          flung = fling(coordinatorLayout, child, -child.getTotalScrollRange(), 0,
              targetScrollingOffset <= 0 ? -velocityY : 0);
        } else {
          // We're scrolling up
          flung = fling(coordinatorLayout, child, -child.getTotalScrollRange(), 0, -velocityY);
        }
      }
      return mWasFlung = flung;
    }
  ...
  public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
    ...
    @Override View findFirstDependency(List<View> views) {
    ...
    @Override int getScrollRange(View v) {

...
public class ScrollingWebView extends WebView
  ...
  public interface OnScrollChangeListener {
     ...
     */
    void onScrollChange(ScrollingWebView v, int scrollX, int scrollY,
  ...
  public ScrollingWebView(Context context, AttributeSet attrs, int defStyleAttr) {
  ...
  protected float getBottomFadingEdgeStrength() {
    ...
    final int span = super.computeVerticalScrollRange() - getScrollY() - bottomEdge;
    if (span < length) {
  ...
  private boolean canScroll() {
    return getHeight() < super.computeVerticalScrollRange() + getPaddingTop() + getPaddingBottom();
  }
  ...
  private boolean inChild(int x, int y) {
    ...
    return !(y < getTop() - scrollY
        || y >= super.computeVerticalScrollRange() - scrollY
        || x < getLeft()
        || x >= getRight());
  }
  ...
  public boolean onTouchEvent(MotionEvent ev) {
    ...
    // return true;
    // FIXME We need this to ask the WebView to accept touch event. Touching a Web is different
    // to touching a simple View ... Need some help!
  ...
  private int getScrollRange() {
    return Math.max(0,
        super.computeVerticalScrollRange() - (getHeight() - getPaddingBottom() - getPaddingTop()));
  }
  ...
  public boolean pageScroll(int direction) {
    ...
    if (down) {
      ...
      if (mTempRect.top + height > super.computeVerticalScrollRange()) {
        mTempRect.top = super.computeVerticalScrollRange() - height;
      }
    } else {
      mTempRect.top = getScrollY() - height;
      if (mTempRect.top < 0) {
  ...
  public boolean fullScroll(int direction) {
    ...
    if (down) {
      mTempRect.bottom = super.computeVerticalScrollRange() + getPaddingBottom();
  ...
  public boolean arrowScroll(int direction) {
    ...
    if (nextFocused != null && isWithinDeltaOfScreen(nextFocused, maxJump, getHeight())) {
      ...
      if (direction == View.FOCUS_UP && getScrollY() < scrollDelta) {
        ...
        int daBottom = super.computeVerticalScrollRange();
  ...
  public final void smoothScrollBy(int dx, int dy) {
    ...
    if (duration > ANIMATED_SCROLL_GAP) {
      ...
      final int bottom = super.computeVerticalScrollRange();
  ...
  protected int computeScrollDeltaToGetChildRectOnScreen(Rect rect) {
    ...
    if (rect.bottom < super.computeVerticalScrollRange()) {
    ...
    if (rect.bottom > screenBottom && rect.top > screenTop) {
      ...
      int bottom = super.computeVerticalScrollRange();
  ...
  static class AccessibilityDelegate extends AccessibilityDelegateCompat {
    ...
    public boolean performAccessibilityAction(View host, int action, Bundle arguments) {
      ...
      final ScrollingWebView nsvHost = (ScrollingWebView) host;

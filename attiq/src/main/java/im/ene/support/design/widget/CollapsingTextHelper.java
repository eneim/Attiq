...
final class CollapsingTextHelper {
  ...
  void setCollapsedTextAppearance(int resId) {
    TypedArray a = mView.getContext().obtainStyledAttributes(resId, android.support.design.R
    ...
    if (a.hasValue(android.support.design.R.styleable.TextAppearance_android_textSize)) {
      mCollapsedTextSize = a.getDimensionPixelSize(
          android.support.design.R.styleable.TextAppearance_android_textSize, (int)
              mCollapsedTextSize);
    }
    mCollapsedShadowColor = a.getInt(android.support.design.R.styleable
        .TextAppearance_android_shadowColor, 0);
    mCollapsedShadowDx = a.getFloat(android.support.design.R.styleable
        .TextAppearance_android_shadowDx, 0);
    mCollapsedShadowDy = a.getFloat(android.support.design.R.styleable
        .TextAppearance_android_shadowDy, 0);
    mCollapsedShadowRadius = a.getFloat(android.support.design.R.styleable
        .TextAppearance_android_shadowRadius, 0);
    a.recycle();
  ...
  void setExpandedTextAppearance(int resId) {
    ...
    mExpandedShadowColor = a.getInt(android.support.design.R.styleable
        .TextAppearance_android_shadowColor, 0);
    mExpandedShadowDx = a.getFloat(android.support.design.R.styleable
        .TextAppearance_android_shadowDx, 0);
    mExpandedShadowDy = a.getFloat(android.support.design.R.styleable
        .TextAppearance_android_shadowDy, 0);
    mExpandedShadowRadius = a.getFloat(android.support.design.R.styleable
        .TextAppearance_android_shadowRadius, 0);
    a.recycle();
